...
<header>
    <div class="container">
        ...
        <a onclick="pyRegisterCvt()" target="_blank" href="https://qm.qq.com/cgi-bin/qm/qr?k=a0_nGSJ-ywzRUq3YLoCngJbkshv925vn&jump_from=webapi"><img
...
<nav class="w100">
    <div class="container">
        <img  src="${pageContext.request.contextPath}/img/logo.png" alt="易学教育的logo" onclick="location.href='index.html'"
             draggable="false" >
        <ul class="text_13 f_right">
            ...
            <li><a href="http://www.chengjian100.com/zyxw/ " target="_blank">易学新闻</a></li>
        </ul>
    </div>
</nav>
<div id="detail"></div>
...
<footer>
    <ul>
        <li>
            <img src="${pageContext.request.contextPath}/img/logo.png" alt="" draggable="false">
        </li>
        <li class="mt25">
            <h3>校区地址</h3>
            <ul>
        ...
        <li class="mt25">
            ...
            <ul id="foo_icon">
                ...
                <li>e-mail:iamlyuf@163.com</li>
                <li>电话:135X531X57X 135X531X57X</li>
                <li class="erwei">
                    <br>
                    <div>
                        <img class="weixin" src="${pageContext.request.contextPath}/img/微信公众号.png" alt=""
                             draggable="false">
                        <img class="weibo" src="${pageContext.request.contextPath}/img/微信公众号.jpg" alt=""
                             draggable="false">
                    </div>
                </li>
            </ul>
    ...
    <div class="record">易学教育 &copy; 豫ICP备2020031317号;易学-学易</div>
</footer>
