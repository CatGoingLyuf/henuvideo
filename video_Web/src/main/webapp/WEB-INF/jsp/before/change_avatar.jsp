...
<header>
    <div class="container top_bar clearfix">
        <img src="${pageContext.request.contextPath}/img/logo.png" alt="易学">
        <div id="tele">
            <span>135X531X57X</span>
            <span>135X531X57X</span>
        </div>
    </div>
    <menu>
            ...
            <div id="user_bar">
                <a href="${pageContext.request.contextPath}/user/showMyProfile">
                    ...
                    <c:if test="${not empty user.imgurl}">
                        <img id="avatar" src="http://182.92.89.218:8888/upload/${user.imgurl}" alt="">
                    </c:if>
                    ...
                    <div class="profile_avatar_area">
                        ...
                        <c:if test="${not empty user.imgurl}">
                            <img width="200px" height="200px"
                                 src="http://182.92.89.218:8888/upload/${user.imgurl}">
                        </c:if>
                    ...
                    <div class="profile_ifo_area">
                        <form id="upload_form" enctype="multipart/form-data" method="post"
                            ...
                            <div class="step2">
                                ...
                                <img id="preview">
                                <br>
                                <input type="submit" onclick="return cutImage(image_file)" value="上传"/>
                            </div>
                        </form>
                    </div>
                </div>
...
<footer>
    <div class="container">
        <ul>
            <li><img src="${pageContext.request.contextPath}/img/logo.png" alt="" id="foot_logo"></li>
            <li>版权所有：易学教育&#x3000;&#x3000;&#x3000;&copy;&nbsp;www.chengjian100.com</li>
