...
<head>
    ...
    <meta name="description"
          content="易学教育在线课程视频,为您提供java,python,HTML5,UI,PHP,大数据等学科经典视频教程在线浏览学习,精细化知识点解析,深入浅出,想学不会都难,易学教育,学习成就梦想！">
    <meta name="author" content="">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/base.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/css.css">
    <link rel="icon" href="favicon.png" type="image/png"/>
    <title>在线公开课-LYUF教育|java|大数据|HTML5|python|UI|PHP视频教程</title>
...
<header>
    <div class="container">
        ...
        <a href="${pageContext.request.contextPath}/admin/toLoginView"><img
                src="${pageContext.request.contextPath}/img/we.png">管理员登录</a>
        <a onclick="pyRegisterCvt()" target="_blank"
           href="https://qm.qq.com/cgi-bin/qm/qr?k=a0_nGSJ-ywzRUq3YLoCngJbkshv925vn&jump_from=webapi"><img
                src="${pageContext.request.contextPath}/img/we.png" draggable="false">联系我们</a>
        <a class="color_e4"><img src="${pageContext.request.contextPath}/img/phone.png" draggable="false"> 135X531X57X&#x3000;&#x3000;135X531X57X</a>
...
<div class="course">
    <div class="container">
        ...
        <div class="course-info">
            ...
            <!--马上试听-->
            <a onclick="pyRegisterCvt()" target="_blank"
               href="https://qm.qq.com/cgi-bin/qm/qr?k=a0_nGSJ-ywzRUq3YLoCngJbkshv925vn&jump_from=webapi">
...
<div class="form_area">
    <div class="container">
        ...
        <form id="iform" action="" >
            ...
            <div class="wrap">
                <div><label for="nickname">姓名：</label>
                    <input name="nickname" id="nickname" type="text" class="form-control"/>
                </div>
                <div><label for="phonenum">手机号：</label>
                    <input name="phonenum" id="phonenum" type="text" class="form-control"/>
                </div>
                <div><label for="email">邮箱：</label>
                    <input name="email" id="email" type="text" class="form-control"/>
                    <input name="password" id="password" type="hidden" value="123456"/>
                </div>
            </div>
            <input class="button" type="submit" onclick="return joinus()" value="立即加入我们"/>
        </form>
    </div>
</div>
<!--页脚-->
<footer>
    ...
    <ul>
        ...
        <li class="mt25">
            <h3>校区地址</h3>
            <ul>
                <li>地址<br>河南省开封市河南大学金明校区</li>
                <br>
                <br>
                <div>
                    <img src="${pageContext.request.contextPath}/img/logo4.png" alt="" draggable="false">
                </div>
            </ul>
        </li>
        ...
        <li class="mt25">
            <h3>联系我们</h3>
            <ul id="foo_icon">
                <li>河南省开封市河南大学金明校区软件学院</li>
                <li>e-mail:iamlyuf@136.com</li>
                <%--                <li>电话:135X531X57X</li>--%>
                <li>微信二维码:</li>
                <li class="erwei">
                    <br>
                    <div>
...
<%--                             draggable="false">--%>
    ...
    <div class="record">LYUF &copy; 豫ICP备2020031317号</div>
</footer>
